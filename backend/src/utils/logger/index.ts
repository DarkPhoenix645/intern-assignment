...
const EVENT_TYPES = [EventType.USER_REQ, EventType.USER_ERR, EventType.SERVER_ERR, EventType.SERVER_MSG];
const LOG_LEVELS: LogLevel[] = ['info', 'error', 'warn', 'debug', 'verbose', 'http', 'silly'];

const baseLogger: WinstonLogger = process.env.NODE_ENV === 'production' ? prodLogger() : devLogger();
